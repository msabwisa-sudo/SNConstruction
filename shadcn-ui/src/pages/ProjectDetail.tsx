...
const projectsData = {
  ...
  '2': {
    ...
    image: '/assets/project-marina-residences_variant_1.jpg',
    type: 'Luxury Apartments',
    units: 48,
    completion: 'Q4 2025',
    fundingPercentage: 72,
    status: 'In Progress',
    description: 'Luxury waterfront living with panoramic sea views. This prestigious development offers world-class amenities including a private marina, infinity pools, and exclusive beach access.',
    price: '€450,000 - €850,000',
    size: '120 - 200 m²',
    bedrooms: '2-4',
    bathrooms: '2-3',
    investment: {
      minInvestment: '€450,000',
      expectedROI: '12-15%',
      rentalYield: '7-9%',
    },
    features: [
    ...
    milestones: [
      ...
      { label: 'Construction Phase 1', percentage: 72, completed: false },
      { label: 'Interior Finishing', percentage: 50, completed: false },
      { label: 'Final Completion', percentage: 0, completed: false },
    ],
  },
  '3': {
